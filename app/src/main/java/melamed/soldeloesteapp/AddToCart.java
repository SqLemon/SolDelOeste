...
public class AddToCart extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        carrito = (Carrito) getIntent().getParcelableExtra("cart");
        listaEntera = (ProductList) getIntent().getParcelableExtra("list");
    ...
    void trySave(){
        ...
        if(!listaEntera.getNombres().contains(nombre)) ((TextInputLayout) findViewById(R.id.dummyL1)).setError("El producto no existe");
        if(!listaEntera.getMarcas().contains(marca)) ((TextInputLayout) findViewById(R.id.dummyL2)).setError("La marca no existe");
        if(nombre.equals("")) ((TextInputLayout) findViewById(R.id.dummyL1)).setError("Campo requerido");
        if(marca.equals("")) ((TextInputLayout) findViewById(R.id.dummyL2)).setError("Campo requerido");
